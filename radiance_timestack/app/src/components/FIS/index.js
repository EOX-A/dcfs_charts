...
export default class FIS extends Component {
  ...
  constructRequestParameters(fromDate, toDate) {
    ...
    let params = {
      ...
      layer: '1_TRUE_COLOR',
      crs: 'CRS:84',
      time: `2019-04-29/2019-05-29`,
      // time: `${fromDate.format('YYYY-MM-DD')}/${toDate.format('YYYY-MM-DD')}`,
      // time: '2019-04-26/2019-05-26',
      // resolution: `${resolution}m`,
      resolution: '10m',
      // geometry: geom,
      // geometry: 'POLYGON ((12.5723 41.8080, 12.5726 41.8080, 12.5726 41.8083, 12.5723 41.8083, 12.5723 41.8080))',
    ...
    //   } else {
    params['evalscript'] = 'cmV0dXJuIFtCMDQqMi41LEIwMyoyLjUsQjAyKjIuNSxCMDQqMi41XTs=';
    params['atmfilter'] = '';
    params['evalscriptoverrides'] = '';
    //   }
